    ...
    <div class="container footer-content">
      <div class="footer-col">
        ...
        <div class="social-links">
          <a href="https://www.linkedin.com/company/ev-go-movers-logistics-india-plc/" target="_blank" rel="noopener noreferrer" style="display:inline-flex; align-items:center; justify-content:center; width:44px; height:44px; background:#0A66C2; border-radius:8px; transition:all 0.3s ease;" onmouseover="this.style.transform='scale(1.1)'" onmouseout="this.style.transform='scale(1)'">
            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="white"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 0 1-2.063-2.065 2.064 2.064 0 1 1 2.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
          </a>
        </div>
      </div>
      <div class="footer-col">
    ...
    <script>
       ...
       if(contactForm) {
           contactForm.addEventListener('submit', function(e) {
               ...
               const message = 'Hello EV GO! I would like to get in touch.%0A%0A' + 
                               '*Name:* ' + name + '%0A' +
                               '*Email:* ' + email + '%0A' +
                               '*Phone:* ' + phone + '%0A%0A' +
                               'Please contact me.';
         ...
         <div class="team-card glass">
            ...
            <div class="team-hover-overlay">
               <p style="font-size: 0.9rem; line-height: 1.6; color: var(--text-light); text-align: left;">
                  Lavish Joshi is the Founder & CEO of EV Go Movers, the visionary behind India's next generation electric logistics platform.<br><br>
                  With a deep passion for sustainable mobility and an entrepreneurial mindset, he has built EV Go Movers from the ground up—creating a company that combines clean technology with world-class logistics execution.<br><br>
                  He leads the overall vision, strategy, and growth of the organization, driving the mission to make electric logistics the new standard across India.
               </p>
            </div>
         </div>
         <div class="team-card glass">
            ...
            <div class="team-info">
               ...
               <div class="team-title">Founder & COO</div>
            </div>
            <div class="team-hover-overlay">
               <p style="font-size: 0.9rem; line-height: 1.6; color: var(--text-light); text-align: left;">
                  Ankit Garg is the Founder & COO of EV Go Movers, responsible for building and scaling the operational backbone of the company.<br><br>
                  He brings sharp expertise in fleet management, supply chain execution, and ground-level operations—ensuring every delivery is reliable, efficient, and on time.<br><br>
                  At EV Go Movers, Ankit drives operational excellence and team performance, translating strategy into seamless day-to-day execution across all markets.
               </p>
            </div>
         </div>
         <div class="team-card glass">
            ...
            <div class="team-info">
               ...
               <div class="team-title">Co-Founder & CBO</div>
            </div>
            <div class="team-hover-overlay">
               <p style="font-size: 0.9rem; line-height: 1.6; color: var(--text-light); text-align: left;">
                  Virendra Kumar, Co-Founder & CBO at EV Go Movers, brings 11.5+ years of experience in data analytics, operational intelligence, and business strategy within the mobility sector.<br><br>
    ...
    content: `
        <div class="grid-2">
            <div>
                 ...
                 <div class="contact-info-item" style="margin-bottom: 20px;">
                 <h4 style="color: var(--primary-green); margin-top: 25px;">Business hours:</h4>
                <p>Monday – Saturday | 8:00 AM – 8:00 PM</p>
                
                <h4 style="color: var(--primary-green); margin-top: 25px;">Operation hours:</h4>
